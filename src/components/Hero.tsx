        ...
        <div className="space-y-4 sm:space-y-2">
          ...
          <div className="flex flex-nowrap justify-center gap-2 sm:gap-4 pt-6 sm:pt-8 px-2 sm:px-4 overflow-x-auto mx-auto">
            <a
              ...
              className="group flex items-center justify-center gap-2 px-3 sm:px-5 py-2.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full transition-all duration-300 border border-gray-300 dark:border-gray-700 shrink-0"
              aria-label="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-center gap-2 px-3 sm:px-5 py-2.5 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-400 rounded-full transition-all duration-300 border border-blue-200 dark:border-blue-800 shrink-0"
              aria-label="LinkedIn"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-center gap-2 px-3 sm:px-5 py-2.5 bg-sky-50 dark:bg-sky-900/30 hover:bg-sky-100 dark:hover:bg-sky-900/50 text-sky-700 dark:text-sky-400 rounded-full transition-all duration-300 border border-sky-200 dark:border-sky-800 shrink-0"
              aria-label="LeetCode"
            >
            ...
            <a
              ...
              className="group flex items-center justify-center gap-2 px-3 sm:px-5 py-2.5 bg-purple-50 dark:bg-purple-900/30 hover:bg-purple-100 dark:hover:bg-purple-900/50 text-purple-700 dark:text-purple-400 rounded-full transition-all duration-300 border border-purple-200 dark:border-purple-800 shrink-0"
              aria-label="Email"
            >
