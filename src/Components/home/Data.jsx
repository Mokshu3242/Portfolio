...
const Data = () => {
  ...
  return (
    <div className="home_data">
      ...
      <h3 className="home_subtitle">AI/ML Developer</h3>
      <p className="home_description text-justify">
        I am an AI/ML developer with expertise in building intelligent systems
        and data-driven models using Python, Java, and C++. With hands-on
        experience in developing machine learning solutions like fraud
        detection, decision trees, and game AI, I apply my knowledge to solve
        real-world problems. As a proactive learner, I continuously work on
        enhancing my skills in AI technologies while also contributing to
        technical projects and events as Technical Head of VCET-NSDC.
      </p>
      <a href="#contact" className="button hbtn">
        Say Hello{" "}
        <svg
